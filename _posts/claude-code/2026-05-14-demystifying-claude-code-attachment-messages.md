...
For where attachments sit in the 11-step message pipeline, see [Managing Message Context]({% post_url claude-code/2026-05-05-demystifying-claude-code-managing-message-context %}), Steps 9-10. For the skill listing attachment specifically, see [Skills]({% post_url claude-code/2026-05-13-demystifying-claude-code-skills %}), Section 4. For how attachments survive compaction, see [Message Compaction]({% post_url claude-code/2026-05-05-demystifying-claude-code-message-compaction %}). For the system prompt sections that reference `<system-reminder>` tags, see [The System Prompt]({% post_url claude-code/2026-05-07-demystifying-claude-code-system-prompt %}), Section 7.
